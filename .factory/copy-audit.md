...
| 12 | 158 starts tested across 5 client time zones over 18 months. |
...
| 6 | The sample starts with a completed check. |
...
| 6 | The sample check makes no third-party requests. |
