...
The sample is a fixed Sunday `01:00–03:30` booking-hours window in `America/New_York`, starting 2026-08-01. It projects five client time zones: London, Kolkata, Sydney, Tokyo, and São Paulo. The 18-month result includes spring and autumn daylight-saving boundaries.
